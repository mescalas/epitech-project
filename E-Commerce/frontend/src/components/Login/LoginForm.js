...
export default function LoginForm() {
    ...
    function handleSubmit(e) {
        ...
        axios
            ...
            .then((res) => {
                setSuccessMessage("Vous êtes désormais connecté.");
                setErrorMessage("");
                localStorage.setItem("SESSID", res.data.token);
                setTimeout(() => {
            ...
            .catch((error) => {
                setSuccessMessage("");
                setErrorMessage("Merci de vérifier vos identifiants.");
            });
    }
                        ...
                        <div className="max-w-md mx-auto">
                            ...
                            <div className="divide-y divide-gray-200">
                                ...
                                >
                                    ...
                                    {errorMessage && (
                                        <span className="bg-red-200 flex items-center font-medium tracking-wide text-red-500 text-xs mt-1 py-3 px-3 rounded-lg">
                                            {" "}
                                            {errorMessage}{" "}
                                        </span>
                                    )}
