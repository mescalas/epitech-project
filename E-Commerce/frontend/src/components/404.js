...
export default function not_found() {
	return (
		<div>
			<svg
				className="h-80vh w-80vw m-auto mt-16"
				id="Layer_1"
				data-name="Layer 1"
				...
				<g>
					...
					<circle cx="371.373" cy="328.351" r="328.305" fill="#FC8621" opacity="0.1"></circle>
					<g>
						<polygon
					...
					<g>
						<g>
							...
							<g opacity="0.4">
								<ellipse cx="302.435" cy="330.166" rx="13.37" ry="7.037" fill="#FC8621"></ellipse>
								<ellipse cx="436.129" cy="330.166" rx="13.37" ry="7.037" fill="#FC8621"></ellipse>
							</g>
						</g>
						<path
			...
			<div className="w-80vw m-auto text-center -mt-40">
				<h1 className="font-404 text-7xl">
					4<span className="text-orange">0</span>4
				</h1>
				<p className="font-404 text-xl">Cette page n'existe pas...</p>
			</div>
			<div className="m-auto mt-20 text-center">
				<a href="/" className="font-body text-orange hover:text-darkorange">
					Revenez à l'accueil
				</a>
			</div>
		</div>
